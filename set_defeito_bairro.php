...
?><?php
    ...
    ?>
	<form action="consulta_defeito_filtrado.php" method="post" >
...
$query_set = sprintf("UPDATE tbl_defeito SET status = '$status'  WHERE bairro = '$bairro' ORDER BY numposte DESC");

// executa a query
$con->query("SET NAMES utf8");
$dado_set = mysqli_query($con,$query_set ) or die(mysql_error());
