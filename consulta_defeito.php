...
?></p>
		 ...
		 <form method="post" action="consulta_defeito_filtrado.php">
...
<!--<label for="a">a</label><input type="radio" id="a" name="filtro" value="LUZ APAGADA A NOITE"/>
<label for="b">b</label><input type="radio" id="b" name="filtro" value="LUZ ACESA DIA"/>
<label for="c">c</label><input type="radio" id="c" name="filtro" value="LUZ PISCANDO"/>-->
...
$query = sprintf("SELECT protocolo,defeito,bairro,logradouro,numposte, data_notf,usuario,status FROM tbl_defeito ORDER BY bairro DESC");
// executa a query
$con->query("SET NAMES utf8");
$dados = mysqli_query($con,$query ) or die(mysql_error());
// transforma os dados em um array
...
<button align="center"> <label><a href="telaadmin.php"><b>VOLTAR</b></a></label></button>
<button align="center"> <label><a href="index.php"><b>SAIR</b></a></label></button>
